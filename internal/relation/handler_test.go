...
func TestRelationServiceImpl_Follow(t *testing.T) {
	...
	t.Run("get user info failed", func(t *testing.T) {
		...
		svc := NewRelationServiceImpl(svcCtx)
		resp, err := svc.Follow(context.Background(), &relation.FollowReq{
			UserId:   1,
			ToUserId: 2,
		})
		assert.Error(t, err)
...
func TestRelationServiceImpl_Unfollow(t *testing.T) {
	...
	t.Run("get user info failed", func(t *testing.T) {
		...
		svc := NewRelationServiceImpl(svcCtx)
		resp, err := svc.Unfollow(context.Background(), &relation.UnfollowReq{
			UserId:   1,
			ToUserId: 2,
		})
		assert.Error(t, err)
...
func TestRelationServiceImpl_ListFriend(t *testing.T) {
	...
	t.Run("get messages failed", func(t *testing.T) {
		...
		svc.Follow(context.Background(), &relation.FollowReq{
			UserId:   1,
			ToUserId: 2,
		})
		svc.Follow(context.Background(), &relation.FollowReq{
		...
		assert.Zero(t, resp.Users[0].MsgType)
