...
// Source: /home/cksfafwefasdf/gitrepo/toktik/internal/favorite/kitex_gen/favorite/favoriteservice/client.go
...
func (m *MockClient) GetFavoriteInfo(ctx context.Context, Req *favorite.GetFavoriteInfoReq, callOptions ...callopt.Option) (*favorite.GetFavoriteInfoRes, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, Req}
	for _, a := range callOptions {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetFavoriteInfo", varargs...)
	ret0, _ := ret[0].(*favorite.GetFavoriteInfoRes)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetFavoriteInfo indicates an expected call of GetFavoriteInfo.
func (mr *MockClientMockRecorder) GetFavoriteInfo(ctx, Req interface{}, callOptions ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, Req}, callOptions...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFavoriteInfo", reflect.TypeOf((*MockClient)(nil).GetFavoriteInfo), varargs...)
}
